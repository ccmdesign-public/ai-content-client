...
### 4.1 component-patterns.json (REMOVED)
This file was generated by `analyze-components.ts` which has been removed along with the CUBE CSS architecture. Component patterns are now documented in CLAUDE.md.
...
**Sections**:
- `tailwind_compliance`: Tailwind utility class usage
...
### 5.1 analyze-components.ts (REMOVED)
This script scanned the legacy `src/components/ds/` directory and generated CUBE CSS patterns. It has been removed along with the CUBE architecture.
