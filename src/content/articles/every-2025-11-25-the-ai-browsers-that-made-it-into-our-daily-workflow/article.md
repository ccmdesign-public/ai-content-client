---
title: "The AI Browsers That Made It Into Our Daily Workflow"
author: "Every"
platform: "every"
publicationName: "Vibe Check"
url: "https://every.to/vibe-check/the-ai-browsers-that-made-it-into-our-daily-workflow"
...
*This Black Friday: Get 25% off a paid Every subscription [when you upgrade](https://every.to/subscribe)—full access to Every’s AI tools, expert courses, model reviews, and hundreds of essays. Offer ends December 1.*
...
For a decade, browsers have been the least sexy part of the internet experience. Google Chrome dominated so thoroughly—over [70 percent global market share](https://gs.statcounter.com/browser-market-share)—that it felt like the conversation was over. Apple’s Safari stayed by virtue of pre-installations on Macs and iPhones. Firefox retreated; Microsoft’s Internet Explorer quietly retired.

And then, out of nowhere—well, not *nowhere*, as loyal Every readers [might remember](https://arc.net/l/tunudncu)—the ground shifted.

AI browsers—a web browser with AI woven into the experience of using the internet— from [OpenAI](https://every.to/vibe-check/vibe-check-openai-s-new-ai-browser-atlas), [Perplexity](https://www.perplexity.ai/), and [The Browser Company](https://www.thebrowser.company/) all arrived, packaged in flashy launches. The browser wars are officially back.
...
**If you want to see for yourself,** you can try **[Bland’s Voice AI](https://bland.ai/)** for completely free.

Or **for enterprises**, you can **[book a call directly](https://bland.ai/enterprise).**

[Want to sponsor Every? Click here](/cdn-cgi/l/email-protection#6c1f1c03021f031e1f04051c1f2c091a091e15421803).
...
In the last week of October, OpenAI finally released [its long-awaited browser](https://every.to/vibe-check/vibe-check-openai-s-new-ai-browser-atlas): [Atlas](https://openai.com/index/introducing-chatgpt-atlas/). It’s available for anyone to download and use, even if you’re not paying for ChatGPT. The browser is currently macOS-only, with support for Windows and other platforms on the way.
...
Inside Every, **[Anukshi Mittal](https://www.anukshi.com/)** and **[Victor Stepanov](https://www.linkedin.com/in/victor-stepanov/)**—both tech-forward generalists—are the browser’s most consistent users. Atlas makes ChatGPT, and the context it needs to be useful based on your browser patterns, available wherever you are on the web in a sidebar, eliminating the need to switch between tabs or copy and paste text from a website to the chatbot. “\[I\]nstead of taking a screenshot and uploading it…I can just open the tab and ask questions in the right side panel,” Victor says. “This alone already makes my life so much simpler.”
...
Anukshi does all her reading on Atlas, because of how easy it is to interact with the material —if she has a question, she can call up ChatGPT in the panel without having to shuttle between tabs. She recently used this feature to better understand the arguments in **[Dan Shipper](https://every.to/@danshipper)**’s essay on [developing a new worldview](https://every.to/chain-of-thought/seeing-like-a-language-model) while living in a world with AI. Other AI browsers can do the same, but Atlas is the first one she’s used, and with OpenAI’s huge user base, she suspects many others are in the same boat.
...
In Atlas, you type into a single search bar, and the browser decides whether your query should go to ChatGPT or to Google (you can manually toggle it, but the default behavior often guesses wrong). Sometimes you just need a plain old Google search for something like “3 p.m. in Amsterdam is what time in NYC”—and Atlas can be a little too eager to route everything to ChatGPT. (Time zone conversions are [notoriously](https://www.linkedin.com/posts/pablovelasquezmejia_ai-is-just-as-bad-with-dates-as-developers-activity-7372071298275127296-i1Bf/) [challenging](https://www.linkedin.com/posts/matthew-paunicka-cpa-2b51806a_even-llms-can-stumble-when-dealing-with-the-activity-7303448044719550464-ZT97/) for LLMs to tackle.) “I get annoyed when I type something that’s clearly a search query and it just wants to chat,” **[Katie Parrott](https://every.to/@katie.parrott12)** says. Victor feels the same, adding that when Atlas runs a full ChatGPT query he can “physically feel tokens being wasted for nothing.”
...
[Dia](https://www.diabrowser.com/) is the latest browser from The Browser Company, the eponymous New York-based startup that was acquired by [software giant Atlassian in September](https://www.atlassian.com/blog/announcements/atlassian-acquires-the-browser-company). The team’s first browser, [Arc](https://every.to/podcast/inside-the-browser-company-why-they-killed-arc-to-build-dia), which first launched in 2023, is still beloved by many inside Every, like executive operations lead **[Jalaiyah Bolden](https://www.linkedin.com/in/jalaiyah-bolden)**, editor in chief **[Kate Lee](https://x.com/katelaurielee)**, and me.

Dia’s features include a side-panel AI assistant with access to all your tabs and windows, so you can ask it to “summarize this article” or “look at all the Airbnbs I’m considering and tell me which one is closest to the beach” without ever leaving the page. It also introduces “[Skills](https://www.diabrowser.com/skills),” shortcuts designed to automate your repeatable workflows, such as [writing up a quick summary](https://www.diabrowser.com/skills/dailywrap-malay) of what you did all day, and [fact-checking the text](https://www.diabrowser.com/skills/fact-check) on a webpage.

Dia is free to download and use. The free tier gives you access to all core features, while a $20 per month [Dia Pro](https://www.diabrowser.com/pro) subscription unlocks unlimited chat usage.

The Dia fan club at Every includes three developers—**[Yash Poojary](https://every.to/@yashpoojary)**, **[Danny Aziz](https://every.to/@dannyaziz97)**, and Naveen—and one very enthusiastic generalist, **[Lucas Crespo](https://every.to/@lucascrespo)**. All three said that they chose to undergo the high-friction process of switching browsers because it had been made by The Browser Company. The Browser Company is unusually good at crafting products that feel handmade, full of small, intentional details—and at [telling a story](https://every.to/podcast/the-browser-company-is-building-a-brand-that-drives-viral-growth) that makes you want to be part of it.
...
Dia lets a single user create multiple profiles, a feature Naveen loves. He has a personal one, an Every one, one dedicated to **[Monologue](https://monologue.to)**, and so on. Being able to split his browser this way allows him to cleanly separate out context for each of these projects.
...
At Every, **[Natalia Quintero](https://x.com/NataliaZarina)** and **[Brandon Gell](https://every.to/@brandon_5263)** are the two most consistent Comet users. Natalia had already experimented with a few AI browsers: She appreciated Dia’s charm but felt its AI features were layered onto an otherwise standard browser, while Atlas showed promise but felt too buggy to rely on day-to-day; specifically, if she tried to go to a website by typing its name, Atlas would hijack the request and give her a ChatGPT answer instead. What pulled her toward Comet was curiosity about how Perplexity’s browser would work in tandem with [Perplexity’s AI email assistant](https://www.perplexity.ai/assistant) that she uses. “I find Comet is much better at choosing when to be an LLM v. \[a\] browser,” she says.
...
Danny and **[Kieran Klaassen](https://every.to/@kieran_1355)** build for the web, so using Chrome—the browser most of the world actually uses—makes more sense to them. While Danny uses Dia sometimes, he does most of his development work in Chrome.

#### AI’s big privacy problem

**[Anthony Scarpulla](https://x.com/vinyl_bones)** cites privacy concerns: “As a social media manager, I’m more concerned with possible security breaches than anything, and don’t love having a [potential rogue AI agent](https://futurism.com/artificial-intelligence/serious-new-hack-openai-ai-browser) [running amok](https://www.straiker.ai/blog/the-silent-exfiltration-zero-click-agentic-ai-hack-that-can-leak-your-google-drive-with-one-email) in my browser.” He’s confident we’ll eventually reach a point where those risks are mitigated, but for now, it’s not worth making the jump.
...
[Amazing](/vibe-check/the-ai-browsers-that-made-it-into-our-daily-workflow/feedback?rating=amazing) [Good](/vibe-check/the-ai-browsers-that-made-it-into-our-daily-workflow/feedback?rating=good) [Meh](/vibe-check/the-ai-browsers-that-made-it-into-our-daily-workflow/feedback?rating=meh) [Bad](/vibe-check/the-ai-browsers-that-made-it-into-our-daily-workflow/feedback?rating=bad)