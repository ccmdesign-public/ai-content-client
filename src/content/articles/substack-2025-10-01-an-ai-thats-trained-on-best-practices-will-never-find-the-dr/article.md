---
title: "An AI that's trained on best practices will never find the dragons"
subtitle: "How to escape the \"faster, cheaper\" trap by using AI for category creation instead of content creation."
...
![](https://substackcdn.com/image/fetch/$s_!6yII!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24cae242-b743-4873-8718-0d562d731ed3_365x253.png)
...
![](https://substackcdn.com/image/fetch/$s_!M6Cq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa36584f4-4dbf-42cb-8de4-03dd234095d9_1408x768.png)
...
1.  **Gather your intel:** Collect the URLs of your top 3-5 competitors. You want their primary blog/content hub, their social media profiles (for Twitter/LinkedIn, you may need to save recent posts to a document) and links to their top 3-5 most popular articles or podcasts.
    
2.  **Use a research-focused AI:** This is a perfect job for a tool like Perplexity *(or ChatGPT Plus, or Claude API, or Google Gemini’s URL context tool)*, which can analyze content from URLs. You will use it to create a dossier on each competitor.
    
3.  **Execute the prompt:** For each competitor, feed the collected intelligence into your AI assistant. Think of yourself as performing a forensic analysis.
...
Output format: Specific examples with direct quotes. For every insight, cite the exact URL and passage that revealed it. Prioritize non-obvious findings—anything you could learn from a basic keyword scan doesn’t count
```

This prompt adds **temporal analysis** (how strategy evolves), **psychological deconstruction** (belief systems), and **activation mechanics** (behavioral intent), which standard competitive analysis misses.
...
![](https://substackcdn.com/image/fetch/$s_!fUvb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc7f5a40b-7e7e-4096-a207-1127e61e213f_1408x768.png)
...
- Provide hypothesis for why each gap exists (capability limitation, strategic choice, market positioning)
```

Feed the AI your competitor data. The output will help you fill the columns.
...
For my own product, [Yahini](https://yahini.io/), this exact process was a complete game-changer. Our competitors were all shouting about “AI content creation.” We fed their blogs and social posts into an analyzer.
...
Output format: For each question, provide a 1-5 score (1 = major red flag, 5 = strong green light) with specific reasoning. Then calculate an overall viability score and recommend: Pursue, Pivot, or Abandon.
```

Your ability to answer these questions determines if you’ve found a puddle or a deep, profitable pond.
...
Tone: Confident but curious. Challenge ideas, not people. Use “we” not “you.” The goal is to spark “finally, someone said it” reactions, not applause.
```

Deploy this test kit. Watch the comments. See which posts get shares.

![](https://substackcdn.com/image/fetch/$s_!ijHI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1a40854f-6f98-46a6-b1e6-f8d35fb3bd75_1408x768.png)
...
**See a “conversation gap” in your own team’s strategy? Share this framework to help them see it, too.**
...
Hemingway knew this. The legend goes that he’d **[stop writing mid-sentence](https://bigthink.com/the-learning-curve/the-hemingway-effect/)** at the end of each day.
...
The overarching theme of everything I’m talking about today has a name: **[Blue Ocean Strategy](https://www.goodreads.com/book/show/4898.Blue_Ocean_Strategy)**. It’s the title of a phenomenal book by W. Chan Kim and Renée Mauborgne.
...
![](https://substackcdn.com/image/fetch/$s_!9jNP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd2432f3c-24e3-401e-a615-27a177bce08b_1155x561.png)
...
[Leave a comment](https://robotsatemyhomework.substack.com/p/an-ai-thats-trained-on-best-practices/comments)
...
](https://robotsatemyhomework.substack.com/p/your-first-idea-is-probably-bad)[Mia Kiraki 🎭](https://substack.com/profile/362428399-mia-kiraki)·August 20, 2025[Read full story](https://robotsatemyhomework.substack.com/p/your-first-idea-is-probably-bad)[
