---
title: "How to Use NotebookLM with Gemini: A Practical Guide with 30 Use Cases"
subtitle: "Google connected Gemini to NotebookLM. Here are 30 use cases across work, learning, personal projects, and creative work — with video walkthroughs and a downloadable guide."
author: "AI Supremacy"
platform: "substack"
...
![NotebookLM and Gemini, by Alphabet are now state-of-the-art.](https://substackcdn.com/image/fetch/$s_!D5rs!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff6eff63d-94a0-4e0b-b10c-739ad7bd909c_613x382.png)

View [more guides](https://www.ai-supremacy.com/s/guides) like this one.

Good Morning

*It’s Chinese New Year period in these parts so my cadence may be lower than usual in mid to late February due to family commitments*. When you think about Generative AI, it’s becoming more accessible to more AI enthusiasts of all ages. Early pilots of tools are becoming more streamlined with better user interfaces. I think [Gemini](https://one.google.com/ai) and NotebookLM are great examples of this.

It’s one thing to write about the latest AI News but at a certain point I also want to inspire folk to use AI more, especially those who might be on the fence and who may have more discretionary time. [Daria Cupareanu](https://open.substack.com/users/180057984-daria-cupareanu?utm_source=mentions) is one of my go-to writers who inspires with easy to understand examples of how to use AI for a wide range of readers.

#### AI Blew my Mind 🤯

Turn your decades of experience into useful Al systems.

[![](https://substackcdn.com/image/fetch/$s_!vwAY!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd6e4c991-b167-4eac-8599-504a3f602a2c_1024x1024.png)AI blew my mindTurn your decades of expertise into AI systems that earn more while you work less. Every week, I help you rethink how you operate and build workflows that run for you. (So good, readers say they cancel their day when a new issue drops.)By Daria Cupareanu](https://aiblewmymind.substack.com?utm_source=substack&utm_campaign=publication_embed&utm_medium=web)
...
-   **Every Google AI Tool in 2026:** [What Each One Does and When to Use It](https://aiblewmymind.substack.com/p/google-ai-tools-2026-guide)
    

Many retired professionals read this Newsletter and I want to recognize and thank them and say that this piece is for you. If you appreciate our efforts here, why not give us some support:

Daria is an expert at providing real-world use cases, and fun & accessible ways to think about how to use tools that you may have heard about in passing but haven’t really applied necessarily to your life and workflows.

## **How to Use NotebookLM with Gemini**

With video explainers.

Read more of [Daria Cupareanu](https://open.substack.com/users/180057984-daria-cupareanu?utm_source=mentions):

-   **How I Went From Chasing AI Tools** [to Building AI Systems](https://aiblewmymind.substack.com/p/from-ai-tools-to-building-systems)
    
-   **How to Reduce AI Hallucinations:** [7 Research-Backed Techniques](https://aiblewmymind.substack.com/p/how-to-reduce-ai-hallucinations)
...
Learn more [about Daria](https://aiblewmymind.substack.com/about).

If you’ve spent time exploring AI tools over the past two years, you’ve probably come across [NotebookLM](https://notebooklm.google/).
...
![](https://substackcdn.com/image/fetch/$s_!dvsM!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb998f5bc-64e6-430e-b167-c52c30ac02a4_1280x720.png)

It’s basically a research assistant that only reads what you give it. That’s the whole reason people love it.

While general-purpose AI models pull answers from anywhere and can confidently tell you something that [sounds right but isn’t](https://aiblewmymind.substack.com/p/how-to-reduce-ai-hallucinations), NotebookLM sticks to your sources. The hallucination rate is significantly lower.

![](https://substackcdn.com/image/fetch/$s_!2sXB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F066dd3d8-8f9a-471d-9efb-b5383c050225_640x480.png)

*Overall rate of hallucination per tool. [Access source](https://arxiv.org/html/2509.25498v1#:~:text=From%20a%20technical%20perspective%2C%20hallucinations,2023;%20OpenAI%2C%202025\)%20.).*

Lower hallucinations, plus the way it lets you cluster and organize your resources for anything from research to data analysis to building knowledge bases, made NotebookLM one of [Google](https://aiblewmymind.substack.com/p/google-ai-tools-2026-guide)‘s most successful AI experiments. And its popularity keeps growing.

![](https://substackcdn.com/image/fetch/$s_!gEQB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe57e835b-248b-4de2-b82c-5f384796d2bc_1600x729.png)

*[Google Trends](https://trends.google.com/trends/explore?q=%2Fg%2F11vsw7nxj5&date=2024-02-01%202026-02-10&legacy&hl=en-GB)*

I get why. It’s one of the tools I now use almost daily to [make sense of things](https://aiblewmymind.substack.com/p/claude-skills-36-examples), to store things about my projects, to help me with my [writing](https://aiblewmymind.substack.com/p/notebooklm-was-built-for-research), to create [shared knowledge bases](https://aiblewmymind.substack.com/p/agentic-commerce-universal-commerce-protocol-guide) for readers or for clients. At this point, it’s just become part of how I work.
...
1.  Build a research assistant that already knows your world
    
2.  Turn trusted research into guided learning and interactive formats
    
3.  Repurpose your content archive into new formats
    
4.  Turn technical documentation into something you can use
    
5.  Get any expert as your personal consultant
    
6.  Create branded presentations from your research
...
-   **Limited creative flexibility.** NotebookLM is brilliant at answering questions and summarizing. But when you want to build something new from those sources, it gets clunky. I found a few hacks to [make it write more like me](https://aiblewmymind.substack.com/p/notebooklm-was-built-for-research), but iterating on the output isn’t the same as working with an LLM. Your options were taking it to another tool to finish or reprompting from scratch, and that’s not ideal.
...
*This integration first rolled out to individual Google users in December 2025, and Google recently extended it to [Workspace](https://workspaceupdates.googleblog.com/2026/01/take-notebooks-further-notebooklm-gemini.html) (business) accounts too.*
...
![](https://substackcdn.com/image/fetch/$s_!S5Mz!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F719736e8-da99-4654-8604-fd055c5e2dfe_1580x820.jpeg)

1.  Open Gemini ([gemini.google.com](http://gemini.google.com) or the app)
    
2.  Start a new conversation
    
3.  Click the **+** icon where you’d normally *attach a file*. You’ll see a new option: NotebookLM
    
4.  Select one or multiple notebooks
...
![](https://substackcdn.com/image/fetch/$s_!qz5u!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc5436b13-e0dc-4d7d-9990-98956b1b48c6_1280x720.jpeg)

How to create a Gem:

1.  Go to Gemini
    
2.  Click **“Gems”** in the sidebar to open the Gem Manager
    
3.  Click **“New Gem”**
    
4.  Give it a name
    
5.  Write instructions explaining what it should do and how it should use the attached knowledge
    
6.  Choose a default tool if you want (Deep Research for thorough web searches, Canvas for building interactive content, Guided Learning for study paths, and others)
    
7.  Under **Knowledge**, click to add sources. This is where you select your NotebookLM notebooks.
    

**One more thing that works across both:** whatever Gemini produces, you can export it directly to a Google Doc, send it as an email, or even listen to it read aloud. If you’re already in the [Google ecosystem](https://aiblewmymind.substack.com/p/google-ai-tools-2026-guide), everything connects.

![](https://substackcdn.com/image/fetch/$s_!mkli!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fabf75542-0352-49d8-9da2-fae799539d39_1280x720.jpeg)
...
**Context:** Every major AI tool has detailed technical documentation on how to [get better results](https://aiblewmymind.substack.com/p/how-to-learn-any-ai-tool-fast) from it. But it’s long, dense, and hard to read. I wanted a faster way to extract the best practices and turn them into something I can use.
...
**[Download the full list with all 30 use cases](https://docs.google.com/document/d/1tsjQIUsNJEz40pUqunopZgnjSrmK6nfB/edit)**
...
[Leave a comment](https://www.ai-supremacy.com/p/how-to-use-notebooklm-with-gemini-real-use-cases/comments)
...
1.  **How to Use** [NotebookLM with Claude Code](https://www.ai-supremacy.com/p/how-to-use-notebooklm-with-claude-code-2026)
    
2.  **How to get into AI for** [Non-Technical Late Bloomers: A Beginner’s Guide](https://www.ai-supremacy.com/p/how-to-get-into-ai-for-non-technical-beginners-older-adults)
    
3.  **The 5 Claude Skills** [Every Digital Product Creator Needs](https://www.ai-supremacy.com/p/the-5-claude-skills-every-digital-creator-needs-agent-orchestration-context-engineering)
    
4.  **NotebookLM Got New Updates:** [How I Built a Learning System That Matches How My Brain Works](https://www.ai-supremacy.com/p/notebooklm-got-new-updates-how-i-use-it-2025)
...
-   [36 Claude Skills Examples to Transform How You Work (From 23 Creators)](https://aiblewmymind.substack.com/p/claude-skills-36-examples)
    
-   [The Claude Skills That Finally Made AI Write Like Me (And How to Build Yours)](https://aiblewmymind.substack.com/p/claude-skills-ai-write-like-you)
    
-   [Claude Cowork: 10 Use Cases I Tested + 67 More by Profession](https://aiblewmymind.substack.com/p/claude-cowork-use-cases-guide)
    
-   [How I Built a Personal AI Assistant (Step-by-Step, No Coding Required)](https://aiblewmymind.substack.com/p/how-i-built-an-ai-personal-assistant)
    
-   [5 No-Code Tools I Built in Google AI Studio (With Prompts)](https://aiblewmymind.substack.com/p/i-built-5-everyday-tools-with-google)