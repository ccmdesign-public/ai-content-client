...
subtitle: "~30 pro-tips for effectively using Gemini CLI for agentic coding"
author: "Addy Osmani"
platform: "substack"
...
*This guide is also available to star/follow on our [GitHub repository](https://github.com/addyosmani/gemini-cli-tips).*
...
![](https://substackcdn.com/image/fetch/$s_!3ImM!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe58f305f-a049-48f5-a77a-489c731faa7f_1736x1068.png)
...
**Quick use-case:** Speed up repetitive tasks by defining [your own slash commands](https://cloud.google.com/blog/topics/developers-practitioners/gemini-cli-custom-slash-commands). For example, you could make a command `/test:gen` that generates unit tests from a description, or `/db:reset` that drops and recreates a test database. This extends Gemini CLI’s functionality with one-liners tailored to your workflow.
...
*Above is a [demo](https://medium.com/google-cloud/gemini-cli-figma-mcp-server-turn-design-into-code-in-minutes-88ba219615c6) of Gemini CLI being used with the Figma MCP for design => code*

*The [Chrome DevTools MCP](https://developer.chrome.com/blog/chrome-devtools-mcp) is also of course a favorite :)*
...
![](https://substackcdn.com/image/fetch/$s_!pgoR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F058154ba-d894-488a-8d44-6590fa2d8a6e_2048x1047.jpeg)
...
![Image](https://substackcdn.com/image/fetch/$s_!lF0Q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27408abe-16e2-4b3a-95ae-3b0b3ac4f8eb_866x418.png)
...
Extensions are a game-changer introduced in late 2025: they allow you to **customize and expand** Gemini CLI’s functionality in a modular [way](https://blog.google/technology/developers/gemini-cli-extensions/#:~:text=Gemini%20CLI%20is%20an%20open,design%20platforms%20to%20payment%20services). An extension is essentially a bundle of configurations (and optionally code) that connects Gemini CLI to an external tool or service. One of my [favorite examples](https://x.com/rseroter/status/1973809454564134970) was the Nano Banana extension, as highlighted by Richard Seroter:
...
![Image](https://substackcdn.com/image/fetch/$s_!0Cuq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a01a315-17e0-45b3-89a2-19c8d569717f_1820x1512.png)
...
![](https://substackcdn.com/image/fetch/$s_!B4nC!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcb0e235e-62c4-4acb-bc97-395c406eda51_5246x3496.png)