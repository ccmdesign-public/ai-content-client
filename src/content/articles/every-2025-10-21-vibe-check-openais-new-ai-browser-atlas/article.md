---
title: "Vibe Check: OpenAI’s New AI Browser, Atlas"
author: "Every"
platform: "every"
publicationName: "Vibe Check"
url: "https://every.to/vibe-check/vibe-check-openai-s-new-ai-browser-atlas"
...
It’s called Atlas. It joins Perplexity’s Comet and [The Browser Company’s Dia](https://every.to/podcast/inside-the-browser-company-why-they-killed-arc-to-build-dia) as the latest entrant in the AI browser wars. Funnily enough, Dia was [acquired](https://www.atlassian.com/blog/announcements/atlassian-acquires-the-browser-company) in a $610 million transaction that closed yesterday by the aptly named Atlassian. So now we have Atlas versus Atlassian: the titan who holds up the world versus his band of followers.

This is a move that has been long-rumored and was inevitable: There’s tremendous power in owning the browser layer. And it puts Google on notice. For two decades, Chrome plus Google Search has been the gateway to the internet. But when your browser has ChatGPT built in—with memory, agents, and task execution—why start with search? In December 2022, I [wrote that browsers](https://every.to/chain-of-thought/i-trained-a-gpt-3-chatbot-on-every-episode-of-my-favorite-podcast) sit between the user and the internet, and they [can see the entire process of work](https://every.to/chain-of-thought/a-few-things-i-believe-about-ai) from start to finish—so they’re a natural place for AI to exist.
...
The OpenAI team told us that they’re focusing on everyday use cases for a broad range of consumers with this release, so it’s worth pointing out that **[Katie Parrott](https://every.to/@katie.parrott12)**, our resident normie who speaks for the non-coders, got her hands on Atlas and had it shopping for Bibles within five minutes of downloading. It looks enough like a browser you’re familiar with—a search bar plus tabs for various content types, including images, videos, and news—that you won’t get lost, and it provides helpful suggestions for how to use it based on your ChatGPT usage patterns and history, so you can start executing tasks that feel relevant right away.
...
[Save your seat now](https://claude101.every.to/?source=post_button)[Want to sponsor Every? Click here](/cdn-cgi/l/email-protection#5427243b3a273b26273c3d242714312231262d7a203b).
...
If you’ve been an AI coding skeptic previously, today should force you to reconsider. Can anyone remember a time when companies the size of OpenAI were releasing new products with so much speed? OpenAI launched a new social media app [Sora 2](https://every.to/vibe-check/openai-made-video-creation-effortless-here-s-what-happened-next) less than a month ago—and now they’ve launched a new browser.
...
[Amazing](/vibe-check/vibe-check-openai-s-new-ai-browser-atlas/feedback?rating=amazing) [Good](/vibe-check/vibe-check-openai-s-new-ai-browser-atlas/feedback?rating=good) [Meh](/vibe-check/vibe-check-openai-s-new-ai-browser-atlas/feedback?rating=meh) [Bad](/vibe-check/vibe-check-openai-s-new-ai-browser-atlas/feedback?rating=bad)