...
*Inspired by recent* [AI & I](https://every.to/podcast) *guest* ***[Nadia Asparouhova](https://every.to/podcast/what-jhana-meditation-can-teach-us-about-llms)****,* ***[Dan Shipper](https://every.to/@danshipper)*** *is away on a Jhana meditation retreat. In lieu of him saying, well, anything this week, we’re republishing his piece from last fall about the [importance of context](https://every.to/chain-of-thought/how-to-figure-out-what-people-want) in building products. It’s a topic on which [Thesis](https://every.to/thesis) writer* ***[Tina He](https://every.to/thesis/the-race-is-on-to-redesign-everything-for-ai-agents)*** *recently co-wrote a [paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5277474) in regards to LLMs—we’ll have more to say on it soon.—[Kate Lee](https://every.to/on-every/kate-lee-joins-every-as-editor-in-chief)*

*Was this newsletter forwarded to you? [Sign up](https://every.to/account) to get it in your inbox.*

* * *

A common piece of [startup](https://every.to/c/ai-frontiers) advice from the last 10-15 years is: ["Make something people want."](https://paulgraham.com/good.html) It resonates because it effectively distills the core job of a founder into a phrase. Unfortunately, it’s not very actionable. It’s sort of like telling an investor: “Beat the market.”

In both of these cases, the obvious next question is: “How?”

A dominant framework for thinking about this question is to consider customer needs. Under this worldview, people simply buy the products they need. Or to put it another way, they [“hire”](https://hbr.org/2016/09/know-your-customers-jobs-to-be-done) products to do specific jobs for them.
...
if (typeof window.posthog !== "undefined") { window.posthog.capture("post\_truncated\_for\_logged\_out\_user", { post\_id: "3603", type: "logged\_out\_preview\_paywall\_variant", forced\_variant: false, }); }