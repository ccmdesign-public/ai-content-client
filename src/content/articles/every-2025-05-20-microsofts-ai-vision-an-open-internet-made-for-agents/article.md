...
*Today we’re releasing a special episode of our podcast* [AI & I](https://every.to/podcast)*.* ***Dan Shipper*** *sat down with with* ***Kevin Scott****, Microsoft's CTO, at the Microsoft Build conference. Watch [on](https://x.com/danshipper/status/1924958807773610096) [X](https://x.com/danshipper/status/1924958807773610096) or [YouTube](https://youtu.be/jYHLKtWM164), or listen on [Spotify](https://open.spotify.com/episode/71VhpH1udaLaw0XWNnERLq) or [Apple Podcasts](https://podcasts.apple.com/ca/podcast/ai-and-i/id1719789201?i=1000709196687). Here's a link to the [episode transcript](https://every.to/podcast/transcript-microsoft-s-ai-vision-an-open-internet-made-for-agents).*
...
Think about it like this. As I’m [fond of saying](https://every.to/chain-of-thought/vibe-check-o3-is-out-and-it-s-great), frontier models are jet engines. They’re super powerful, but if you drop a jet engine on my doorstep I won’t be able to do much with it. Stick it on a plane and give me a pilot, though, and the equation changes.

As I’ve been writing since 2023, raw intelligence is only one half of the puzzle. Models are [only as good as the information](https://every.to/chain-of-thought/a-few-things-i-believe-about-ai) they have access to.
...
1.  **Throwing its weight behind MCP.** MCP (model context protocol) is an open standard from Anthropic that allows LLMs to interact with other data sources, like X or Y. Microsoft is adopting MCP as a standard inside all of its platforms—including building MCP support into Windows—to make it easy to wire up an LLM into any part of the Microsoft ecosystem, and any application on your computer. (This is a big deal strategically, especially since Apple still locks up everything in Photos and Notes tighter than **Bill Belichick** locks up during interviews.) (Okay, bad example.)
2.  **Launching NLWeb to make your website chatbot-ready.** NLWeb takes your existing website and makes it easy to consume for chatbots by automatically creating structured data from your site that they can parse. It’s an old idea from the [Semantic Web](https://en.wikipedia.org/wiki/Semantic_Web) reborn in the AI age, so your users can access the information on your website more easily inside of their AI experiences.
3.  **Building the “runtime” layer for agents.** Microsoft will be building components that are necessary for agents to function well: memory, permissions systems for data access, and tools that allow agents to take action on your behalf.
...
Copilot agent is designed to fix that—allowing you to build features and fix bugs with an agent you can communicate with right inside of Github, where you’re already doing a lot of your developer work. It’s [powered by Claude Sonnet 3.7](https://www.axios.com/2025/05/20/ai-agents-software-programming-coding) instead of an OpenAI model, which is particularly interesting given OpenAI’s [Codex launch](https://every.to/chain-of-thought/vibe-check-codex-openai-s-new-coding-agent) last week.
...
I got to interview tech’s most likable executive, Microsoft CTO Kevin Scott, for the [second year in a row](https://every.to/chain-of-thought/working-right-at-the-ragged-edge-of-ai) at Build. We talked about his vision for the agentic web, his passion for craft—whether that’s the code he writes, or the ceramics and bags he hand-makes in his spare time—and how coding changes in a world with programming agents. **You can watch [on](https://x.com/danshipper/status/1924958807773610096) [X](https://x.com/danshipper/status/1924958807773610096) or [YouTube](https://youtu.be/jYHLKtWM164), or listen on [Spotify](https://open.spotify.com/episode/71VhpH1udaLaw0XWNnERLq) or [Apple Podcasts](https://podcasts.apple.com/ca/podcast/ai-and-i/id1719789201?i=1000709196687).**
...
[Amazing](/chain-of-thought/microsoft-s-ai-vision-an-open-internet-made-for-agents/feedback?rating=amazing) [Good](/chain-of-thought/microsoft-s-ai-vision-an-open-internet-made-for-agents/feedback?rating=good) [Meh](/chain-of-thought/microsoft-s-ai-vision-an-open-internet-made-for-agents/feedback?rating=meh) [Bad](/chain-of-thought/microsoft-s-ai-vision-an-open-internet-made-for-agents/feedback?rating=bad)