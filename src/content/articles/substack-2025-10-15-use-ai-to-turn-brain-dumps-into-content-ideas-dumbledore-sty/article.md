---
title: "Use AI to turn brain dumps into content ideas, Dumbledore-style"
subtitle: "A (slightly creepy) workflow that lets you pour your thoughts into a document and have an AI tell you what to write next."
...
Last week, I was feeling completely overwhelmed. My mind was a mess of half-formed thoughts about a new feature for [Yahini](https://yahini.io/), an overhaul of our customers’ onboarding, and a nagging feeling that our content was getting stale.

I found it impossible to focus on any single idea.

And then I thought of Dumbledore…

![](https://substackcdn.com/image/fetch/$s_!GU6L!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9440c001-49f0-4f96-b3ee-a389b5337bde_914x587.webp)
...
![](https://substackcdn.com/image/fetch/$s_!NIey!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa5131159-9c22-47fe-b235-918d31091f06_1280x896.png)
...
**⏱️ Time:** 5 minutes to run the prompt, 2 minutes to read the output
...
![](https://substackcdn.com/image/fetch/$s_!wJPR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F375e26f3-1d2c-4185-bdb8-1799477ed871_1280x896.jpeg)
...
Tell me which theme I should prioritize THIS WEEK and why.
```

**⏱️ Time:** 3 minutes to run, 2 minutes to review
...
![](https://substackcdn.com/image/fetch/$s_!Af7v!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fca080439-a27d-4f61-86d6-50eacd1a93a1_1200x52.png)

Alright, let’s play a delightfully dark game.

There’s a mental model from writer Luca Dellanna called a **[Premortem](https://luca-dellanna.com/derisk-exercise/)**. Most teams wait for a project to crash and burn before they conduct a post-mortem to figure out what went wrong. A Premortem is the opposite. You begin by assuming the project has already failed.
...
![](https://substackcdn.com/image/fetch/$s_!7NiB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fba27c1d8-47a9-4878-9e2f-f97410f21530_1200x35.png)
...
⏱️ **Time:** 5 minutes to run, 3 minutes to review
...
- At least 3 titles should include a specific number or named tactic
```

This is how you move from a vague idea to something sharp and compelling, ready for you to write.
...
This is not about summarizing. This is about finding the signal I’m too close to see.
```
...
**You’ve just learned how to build an AI that reads your mind. Maybe share the blueprints with a friend (or don’t, I respect the competitive advantage).**
...
For this, I want to point you to a brilliant piece by [James Presbitero](https://open.substack.com/users/112381382-james-presbitero?utm_source=mentions) and **[Daria Cupareanu](https://substack.com/@dariacupareanu)** called **“How to Use AI for Writing Without Losing Your Voice.”**

[![](https://substackcdn.com/image/fetch/$s_!tPri!,w_56,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb76ec0aa-5c70-4d20-bcd3-41a49671fd68_300x300.png)Write10xHow to Use AI for Writing Without Losing Your VoiceWelcome to week 2 of Think, Build, Brand, September edition. Today’s edition is for the AI-powered writers and brand builders. We’ll learn powerful AI writing processes from Daria Cupareanu…Read more5 months ago · 47 likes · 27 comments · James Presbitero and Daria Cupareanu](https://write10x.substack.com/p/how-to-use-ai-for-writing-without?utm_source=substack&utm_campaign=post_embed&utm_medium=web)

The connection to this workflow is perfect: they walk through a 5-step writing process, and the Pensieve system is the engine for that critical first phase: generating ideas that can’t be prompted into existence because they come from your specific context and perspective.
...
[Leave a comment](https://robotsatemyhomework.substack.com/p/use-ai-to-turn-brain-dumps-into-content/comments)
