---
title: "When AI Can Do Your Job, Who Else Are You?"
author: "Every"
platform: "every"
...
*Today’s big news, other than the Cloudflare outage (which one Every team member referred to as an “adult snow day”), is that Google’s latest version of its [Gemini model](https://every.to/vibe-check/vibe-check-gemini-2-5-pro-and-gemini-2-5-flash), Gemini 3 Pro, is out. We’re testing it and will be publishing a [Vibe Check](https://every.to/vibe-check) shortly. Until then,* ***[Danny Aziz](https://every.to/@dannyaziz97)****, general manager of* ***Spiral****, wrote about how AI coding tools changed his identity as a software engineer.—[Kate Lee](https://every.to/on-every/kate-lee-joins-every-as-editor-in-chief)*
...
AI shattered that identity. Sometime in March 2025, the technical work that had defined me was suddenly being done by AI tools like Cursor and [Claude Code](https://every.to/source-code/how-i-use-claude-code-to-ship-like-a-team-of-five) without much need for my input. AI was solving the technical problems I used to solve by hand faster and better.
...
The first was coasting. I saw it on X—people letting agents do work while they made coffee or [watched Netflix](https://x.com/andersonlimadev/status/1990390716292345875).
...
if (typeof window.posthog !== "undefined") { window.posthog.capture("post\_truncated\_for\_logged\_out\_user", { post\_id: "3830", type: "logged\_out\_preview\_paywall\_variant", forced\_variant: false, }); }