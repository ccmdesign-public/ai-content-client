...
[Save your seat now](https://claude101.every.to/?source=post_button)[Want to sponsor Every? Click here](/cdn-cgi/l/email-protection#c6b5b6a9a8b5a9b4b5aeafb6b586a3b0a3b4bfe8b2a9).
...
In the new version of Cursor, as a developer makes changes to code, an AI agent reviews them automatically. Kieran was impressed as it fits neatly into his philosophy of [compounding engineering](https://every.to/source-code/my-ai-had-already-fixed-the-code-before-i-saw-it), where small improvements build on each other over time.
...
**[Tom Cruise](https://youtu.be/cR9FMrck4gw?si=kMTAy_xkZ0Kl9nax&t=162)** [had](https://youtu.be/cR9FMrck4gw?si=kMTAy_xkZ0Kl9nax&t=162) **[Renée Zellweger](https://youtu.be/cR9FMrck4gw?si=kMTAy_xkZ0Kl9nax&t=162)**[—and all the rest of us—at hello](https://youtu.be/cR9FMrck4gw?si=kMTAy_xkZ0Kl9nax&t=162) in *Jerry Maguire*, and Cursor had Kieran at the name “Composer 1 Alpha”: “I do love the name…it’s clearly a reference to the first glimpse of Cursor being agentic when [Ian](https://x.com/shaoruu) Huang built Cursor Composer as an experimental feature after Sonnet 3.5 launched, inspired \[also\] by [Artifacts from Claude](https://support.claude.com/en/articles/9487310-what-are-artifacts-and-how-do-i-use-them)—that was a major step up in AI development.” (Kieran is also, incidentally, a music composer.) Here’s what Cursor’s Composer said *after* hello:
...
As Kieran pointed out, we already have “pretty good thinking models” like [Sonnet 4.5](https://every.to/vibe-check/vibe-check-claude-sonnet-4-5), [Opus 4.1](https://every.to/vibe-check/vibe-check-claude-4-sonnet), and [GPT-5 Codex](https://every.to/vibe-check/gpt-5-codex-knows-when-to-think-hard-and-when-not-to), but they are “pretty slow.” He says this cleaves open an interesting space for faster agents: those quick enough such that you can spin up five at once, compare their results, and pick the best, especially for simple coding tasks like merging branches or resolving conflicts.

“Waiting on agents to finish is a waste of time,” he says. “A fast model makes you more productive because it just does more things and makes you less distracted.” He positions Cursor’s model as a competitor to [Haiku 4.5](https://every.to/vibe-check/vibe-check-claude-haiku-4-5-anthropic-cooked), which he already uses for lightweight, everyday development tasks.
...
Anyone who knows Kieran knows just how [Claude Code](https://every.to/source-code/how-i-use-claude-code-to-ship-like-a-team-of-five)–[pilled he is](https://every.to/source-code/my-ai-had-already-fixed-the-code-before-i-saw-it). He loves Anthropic and the tools they make with a nigh unmatched fervor, so you can imagine our surprise when he announced he’d been using Cursor’s new model all day. Kieran usually bounces off new tools fast if they don’t impress him (he’s a tough man to please), and this week he was already under pressure prepping for an upcoming launch for **[Cora](https://cora.computer)**.
...
[Amazing](/vibe-check/vibe-check-cursor-2-0-and-composer-1-alpha/feedback?rating=amazing) [Good](/vibe-check/vibe-check-cursor-2-0-and-composer-1-alpha/feedback?rating=good) [Meh](/vibe-check/vibe-check-cursor-2-0-and-composer-1-alpha/feedback?rating=meh) [Bad](/vibe-check/vibe-check-cursor-2-0-and-composer-1-alpha/feedback?rating=bad)