---
title: "The first rule of AI is “Yes, and…”"
subtitle: "Why your AI assistant keeps stepping on your toes, and the rhythm you need to create great work together."
author: "Robots Ate My Homework"
platform: "substack"
publicationName: "Robots Ate My Homework"
url: "https://robotsatemyhomework.substack.com/p/the-first-rule-of-ai-is-yes-and"
...
[Day in the life of the oracle of Delphi](https://www.youtube.com/watch?v=Wvdy0UQNO9E)
...
As a special treat, I'm so excited to be joined by two modern-day practitioners of this method. Raghav and Ashwin from [Cash & Cache](https://cashandcache.substack.com/) are here to share the exact system they've built for their own creative work.
...
![](https://substackcdn.com/image/fetch/$s_!Lfai!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Face7a10a-7ba6-4fa1-9448-e44fe404d335_1408x768.png)
...
[![](https://substackcdn.com/image/fetch/$s_!n3Vg!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F981d3c34-7973-422b-9d8b-b807da098029_163x163.png)Cash & CacheWhere money meets code - exploring how tech is transforming businesses, markets, and value.By Ashwin Francis](https://cashandcache.substack.com?utm_source=substack&utm_campaign=publication_embed&utm_medium=web)

In their Cash & Cache publication, [Raghav](https://substack.com/@raghavmhra24) and [Ashwin](https://substack.com/@ashwinfrancis) write for those who want clear AI thinking and practical moves. The newsletter publication focuses on AI breakthroughs, real-world case studies, and their applications. They write two pieces every week:
...
[NotebookLM](https://notebooklm.google/) is a wonderful tool to analyze raw data and crystallize it into key insights.
...
We have actually written an extensive piece on using [AI for pain point mining](https://cashandcache.substack.com/p/ai-powered-pain-point-mining-what). Compressing people’s opinions into an organized, analyzed template makes the output more grounded.
...
Goal: help readers act today, not someday.
```

That’s how our Chief Content Creator starts sounding like us instead of generic filler.
...
Study my writing style - how I construct sentences, my choice of words, use of punctuations and how I articulate my view points - to understand my tone.
```
...
```
Create a skeleton for this topic in Cash & Cache style. Include: hook, 3–4 sections with transitions, closing insight. Cap at 6 sections. Add one line under each section that says what proof we’ll use.
```

This saves hours and keeps drafts from wandering.
...
Use clear headers. Add smooth transitions. Mix sentence length.
```

Good enough beats perfect. The loop makes it much better later.
...
```
Play devil’s advocate. List 3 strongest counterarguments, 2 edge cases, and 1 hidden assumption we’re making. Be ruthless.
```

If a point collapses here, it’s out.

For instance, we queried the following claim with our Chief Content Creator:

```
AI is the best way for founders to save time on research. It guarantees faster output and better insights.
```
...
![](https://substackcdn.com/image/fetch/$s_!G2ge!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5e6819ef-3798-4b05-9008-825d1e229289_1408x768.png)
...
```
AI can save founders hours on research, but it’s no replacement for direct customer conversations. Used right, it speeds up the groundwork so you can spend more time learning from the people who matter most.
```
...
```
Rewrite the intro as a tight hook in 2 sentences. Make it quotable. Aim for one punchy line readers can share.
```

If it doesn’t snap when we read it out loud, we try again.
...
```
Add one real-world example in Section 2. 30–60 words. Plain language. No hype.
```
...
If it drifts into generic voice, we roll it back.
...
Use only reputable, evidence-based sources, avoid speculation, and present results in a clear, structured report format.
```

#### **The grading rubric**

![](https://substackcdn.com/image/fetch/$s_!Fvq1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1f2ad93a-2758-4ecb-b530-4c9c9bee7442_1408x768.png)
...
**Want to help someone else have a better conversation with their AI? Be their “Yes, and...”**
...
![](https://substackcdn.com/image/fetch/$s_!jLDo!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Feca0ccbb-60ac-4784-90b3-493408ab1b5d_1408x768.png)
...
The process they outlined is fundamentally about building a relationship. To that end, I want you to read a classic article from the Harvard Business Review: **"[How to Give Feedback That Helps People Grow.](https://hbr.org/2015/08/how-to-give-tough-feedback-that-helps-people-grow)"**
...
[Leave a comment](https://robotsatemyhomework.substack.com/p/the-first-rule-of-ai-is-yes-and/comments)
...
](https://robotsatemyhomework.substack.com/p/your-competitors-are-sketching-their)[Mia Kiraki](https://substack.com/profile/362428399-mia-kiraki)·September 10, 2025[Read full story](https://robotsatemyhomework.substack.com/p/your-competitors-are-sketching-their)[

#### The strategic cost of AI convenience

](https://robotsatemyhomework.substack.com/p/the-strategic-cost-of-ai-convenience)[Mia Kiraki](https://substack.com/profile/362428399-mia-kiraki)·August 13, 2025[Read full story](https://robotsatemyhomework.substack.com/p/the-strategic-cost-of-ai-convenience)[
