---
title: "The shadow fishermen of marketing"
subtitle: "A playbook for escaping the uncanny valley created by AI tourists"
author: "Robots Ate My Homework"
platform: "substack"
publicationName: "Robots Ate My Homework"
url: "https://robotsatemyhomework.substack.com/p/the-shadow-fishermen-of-marketing"
...
![](https://substackcdn.com/image/fetch/$s_!KeSq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F10c81c48-9ea9-4e9e-9bef-3fd46073ba90_683x911.jpeg)
...
[Hvarska Gregada Recipe](https://travelhonestly.com/hvarska-gregada/)
...
![](https://substackcdn.com/image/fetch/$s_!RfYc!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4bb65bbb-dbbd-4f2d-8024-7cd0e4060e7b_1408x768.png)
...
Now you bring in your intern. Give your AI (a tool like Perplexity or use the system we've built at [Yahini](https://yahini.io/)) the topic and your completed POV Brief.
...
3. Ask me the one question I am probably afraid to answer about this topic.
```

This step is terrifying and essential. It forces you to refine your argument from a good idea to a great idea.
...
3. One compelling real-world example or case study (besides the one I have) of this idea in action.
```

Notice we are not asking for generic research. We are dispatching the AI to find proof for our specific, pre-defined argument.
...
* Section 5: The Action - Conclude with a single, clear, and powerful action the reader can take *today* that aligns with this new way of thinking.
```

#### **Step 3: The human step, the final polish**
...
**You're in on the secret to beating the AI tourists now. Help another human out.**
...
![](https://substackcdn.com/image/fetch/$s_!28Kv!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F62a6bc02-addf-4132-9b1f-a37fad091d63_1408x768.png)
...
![](https://substackcdn.com/image/fetch/$s_!SrmY!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F82364039-f4de-4cb0-8759-e3f0b5532975_1408x768.png)
...
Now, rewrite the introduction to be more provocative. Start by stating the opposite, commonly-held belief on this topic. Then, use a phrase like, "But what if that's completely wrong?" or "That's the conventional wisdom. It's also dangerously incomplete." to introduce the article's true thesis.
```

This prompt forces the AI to create tension. It builds a frame for your argument, making your point of view feel more significant and urgent.
