...
url: "https://levelup.gitconnected.com/skill-set-and-study-plan-for-robot-learning-career-29dff16b09c9?source=rss----5517fd7b58a6---4"
...
categories:
  ...
  - "Tools & Productivity"
  - "Web Development"
tagsNormalizedAt: "2026-03-06T19:30:53.665Z"
---
...
## What to study and practice in order to transfer into robotic and deep learning positions

[Yasin Yousif, Ph.D](https://medium.com/@mryasinusif?source=post_page---byline--29dff16b09c9---------------------------------------)

11 min read·3 hours ago

\--

![Robotic Branches (generated by author)]()
...
> **Release early and frequently —** Lean startup principle
...
![Robot Learning as an intersection between two fields (generated by author)]()
...
![Brauches of robotic field and their main methodologies (generated by author)]()
...
-   Resources: [C++ DSA (Data Structure and Algorithms)](https://onlinelibrary.wiley.com/doi/book/10.1002/9781119752059): a book containing a lot of detailed examples and exercises covering both object oriented and functional programming.
...
![Finite State Machine Program for a simple pick-and-place task (generated by author)]()
...
## Get Yasin Yousif, Ph.D’s stories in your inbox
...
These methods will require some mathematical background of instance about metrics operations to understand. Additionally designing and tunning these filters require some practice. The [open source book of Kalman Filtering](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) by Roger Labbe provides great explanation about these topics.
...
One comprehensive free book that delves into the many path planning methods is [Planning Algorthems](https://lavalle.pl/planning/book.pdf) . You may not read it all if your target is specific algorithm, like A star, which can be explained in few pages only. Additionally for a through introduction to the reinforcement learning topic, you can check [our previous post here](https://www.rlbyexample.net/posts/the-reinforcement-learning-algorithmic-landscape/).
...
For a good introductory resource of the topic of robotic arms [Robotics, Vision and Control](https://link.springer.com/book/10.1007/978-3-031-06469-2) provides a detailed explanation of its concepts. A thorough understanding of the book material requires some math background, like the concept of matrices derivatives, and can take around one month.
...
![Main skills and their estimated study time ordered seqationally to qualify for robotic/ml engineer roles. (generated by author)]()
