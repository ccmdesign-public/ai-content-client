...
if (typeof window.posthog !== "undefined") { window.posthog.capture("post\_truncated\_for\_logged\_out\_user", { post\_id: "3896", type: "logged\_out\_preview\_paywall\_variant", forced\_variant: false, }); }