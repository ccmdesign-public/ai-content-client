...
It solved a real iOS coding task that stumped both the GPT-5.3 Codex and [Opus 4.5](/vibe-check/vibe-check-opus-4-5-is-the-coding-model-we-ve-been-waiting-for). It is more thorough, explores context more carefully, and is smarter than Opus 4.5. But this power has trade-offs. It's slower and a bit more verbose, and it still falls prey to classic Claudisms: It sometimes makes changes you didn't expect and doesn't always know its own skills and capabilities.

When it comes to coding, it feels like Anthropic looked at [Codex](/vibe-check/vibe-check-openai-s-codex-app-gains-ground-on-claude-code)'s strong points—thorough, precise work on tough tasks—and tried to incorporate them into this release.
...
![Katie Parrott](/assets/team/katie-b19b8e89bbbb4e73ced8b4eece0c5ccfd4b68d13550e1bf92d8f9589b15cd194.png)Katie Parrott AI-pilled writer by day, vibe coder by nightLegend:
...
[Subscribe to unlock →](/subscribe?utm_source=cornelius_vibecheck)
...
[Get your first 15 days free →](/subscribe?utm_source=cornelius_vibecheck)