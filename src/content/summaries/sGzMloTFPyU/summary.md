...
metadata:
  videoId: "sGzMloTFPyU"
  title: "Antigravity 2 Hour Masterclass: Build & Sell AI Agents & Apps (No Code)"
  ...
  duration: "PT2H35M3S"
  publishedAt: "2026-02-24T15:37:10Z"
  thumbnailUrl: "https://i.ytimg.com/vi/sGzMloTFPyU/hqdefault.jpg"
  youtubeUrl: "https://www.youtube.com/watch?v=sGzMloTFPyU"
processedAt: "2026-02-26T23:40:42.373Z"
source: "youtube"
playlistId: "PL-SEjLl-bojVmsXOvG-TBp7DVv0McXJzn"
playlistName: "AI Summaries"
category: "ai"
tldr: "This comprehensive masterclass teaches how to use Google's Antigravity platform to build and sell AI agentic workflows and web applications with no coding, covering practical projects like a Telegram bot for lead scraping, an analytics dashboard, and an automated Gmail management system."
tools:
  - name: "Antigravity"
...
Jono Catliff demonstrates how to leverage Antigravity as a 'junior developer' to build complex AI-powered systems without writing code.

*   **Agentic Workflows** combine AI automation with intelligent decision-making, allowing systems to think and act like digital employees.

*   **Critical Planning** with `instructions.md` and `project_specs.md` files is essential for guiding Antigravity and avoiding hours of debugging.

*   **Three Live Builds** are created: a Telegram bot for scraping Google Maps to Air Table, a web analytics dashboard pulling from Air Table, and an AI-powered Gmail inbox organizer.

*   **Cloud Deployment** is simplified using Modal for agentic workflows and Vercel for web apps, making projects accessible anywhere.

*   **Probabilistic Nature** of Antigravity means outputs can vary; success requires clear prompts and iterative back-and-forth to course-correct.
...
Jono Catliff is an entrepreneur who has built and sold seven-figure businesses, automating up to 80% of their operations, and runs a paid community of over 400 automation users. This masterclass is part of a broader wave of 'no-code AI' tooling that aims to democratize the creation of sophisticated software. Antigravity represents a significant shift by allowing natural language to directly generate production-ready systems. This content is highly relevant for business owners, freelancers, marketers, and anyone looking to save time through automation or create new income streams by building custom solutions for clients without learning to code.