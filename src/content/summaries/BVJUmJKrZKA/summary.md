...
metadata:
  ...
  duration: "PT1H48S"
  publishedAt: "2025-05-02T12:00:16Z"
  thumbnailUrl: "https://i.ytimg.com/vi/BVJUmJKrZKA/hqdefault.jpg"
  youtubeUrl: "https://www.youtube.com/watch?v=BVJUmJKrZKA"
processedAt: "2026-01-12T23:29:31.937Z"
source: "youtube"
playlistId: "PL-SEjLl-bojVmsXOvG-TBp7DVv0McXJzn"
playlistName: "AI Summaries"
category: "ai"
tldr: "Mig Reyes, VP of Product Experience at **Duolingo**, argues that **UX design** is an archaic term, urging a shift toward **product ownership** where high-level craft and business metrics coexist.\ 

  - **Visual design** is the primary filter in hiring; if execution is weak, the candidate is dismissed.

  - Success requires **high-frequency reps** and proactive communication over long-winded decks.\n"
ai:
  provider: "gemini"
...
Mig Reyes challenges the design industry to move beyond the "advocating for the user" phase and into a phase of **building excellent businesses**. He emphasizes that design's seat at the table is now a given at top companies, meaning designers must step up as **product leaders** rather than just flow-creators.

* **The Death of 'UX'**: Modern consumer companies like Airbnb, Meta, and Duolingo hire **Product Designers**. Labels like "UI/UX" are often seen as red flags for lack of seniority.

* **Management as Craft**: Great design managers must be former **excellent ICs** who can still jump into Figma and articulate the specific "why" behind visual and product details.

* **Visual Design is the Gate**: In consumer tech, portfolios are filtered by **visual execution** first. If the craft isn't there, recruiters won't bother reading the case study.

* **Reps over Decks**: Duolingo prioritizes **10-minute rapid reviews** and prototypes over long-winded documents or 30-slide presentations.

* **Invest in Early Talent**: Duolingo hires ~50% early-career designers to shape their mindset and maintain a **culture of learning** and adaptability.

* **Proactive Communication**: Influential designers broadcast their thoughts frequently. **Unpolished but frequent** communication is more valuable for career growth than rare, polished updates.
...
Mig Reyes is the VP of Product Experience at Duolingo and has held senior leadership roles at **Instagram** and **Basecamp**. This conversation comes at a time of significant upheaval in the design industry, as the post-pandemic market has cooled and the rise of AI is forcing a re-evaluation of the designer's role. Reyes’ insights are particularly relevant for designers struggling to find work or seeking to move into leadership, as he clarifies the shift from **process-oriented** design to **outcome-oriented** product work. His perspective represents the "new guard" of design leadership—one that prioritizes business impact, high-frequency iteration, and a return to high-fidelity craft as the primary measure of value. This video is essential viewing for anyone looking to understand the internal standards of a top-tier consumer tech company like Duolingo.
