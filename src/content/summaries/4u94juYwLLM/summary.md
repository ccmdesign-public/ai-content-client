...
Jenny Wen (Design Lead at Anthropic, formerly Figma) argues that the standardized design process has become a liability that prioritizes strategy over quality.

* **Process vs. Outcome**: Users do not care about personas or journey maps; they care about the end experience. Designers often spend 80% of their time on **process artifacts** rather than the final craft.

* **The AI Shift**: AI is raising the "floor" of design. For designers to remain valuable, they must focus on **taste, curation, and quality**—elements that cannot be prompted.

* **Intuition as a Skill**: Intuition is not guessing; it is a **reasoned judgment shortcut** built by internalizing user feedback, data, and design principles.

* **Solution-First Design**: In the AI era, technology changes so fast that we must often build solutions first to understand what problems they can solve, rather than waiting for a problem statement.
...
* Constantly reading user feedback on platforms like Reddit or Twitter.

* Attending research sessions outside of one's immediate project scope.
...
This talk comes at a pivotal moment in the design industry, following a period of massive layoffs and the rapid integration of generative AI. For years, the 'design process' was used as a tool for professional legitimacy. However, as AI lowers the barrier to creating visual assets and prototypes, the traditional 'Design Thinking' framework is being criticized for producing 'AI slop'—generic, uninspired software. This matters to any product professional who feels bogged down by corporate bureaucracy or is looking to leverage AI to move faster. It marks a shift in the industry's focus back toward 'craft' and 'taste' as the primary differentiators in a saturated market.
