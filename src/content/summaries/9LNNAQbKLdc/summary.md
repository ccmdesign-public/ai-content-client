...
metadata:
  ...
  description: "*Get our free AI Ads Workflows + Prompts to create 1k Ads:* https://clickhubspot.com/wso


    Will every business have a creative agency “coworker” powered by AI?

    Kipp, Kieran, and Patrick Haede (founder of Superscale AI) dive into how autonomous advertising agents are revolutionizing paid ads—making it possible for any business, no matter the size or budget, to compete with the world’s biggest brands.\ 


    00:00 — Intro: AI Agents Are Coming for Advertising

    01:00 — Why Paid Ads Are More Important Than Ever

    02:30 — Super Scale Demo: AI-Generated Video Ads & Avatars

    06:00 — Custom Brand Avatars & Trademarking Digital Characters

    07:30 — The Video Ad Arbitrage: Why Small Businesses Should Care

    09:00 — From Templates to Agents: The Next Stage

    10:00 — One Prompt: Competitor Research + 20 Ads in 5 Minutes

    12:00 — Pricing: $49/Month for Agent-Powered Ads

    13:00 — AI Tools → Agents → Agent Teams → Autonomous Agents

    15:00 — What Differentiates Winners When Everyone Has AI Ads

    17:00 — Ad Velocity: Why Running 100 Creatives Beats 10

    18:00 — Iterating Ads Conversationally (Airbnb Demo)

    20:00 — The Agent Score: Training Your AI Coworker

    22:00 — From Shopify Sync to Brand Guidelines on Autopilot

    24:00 — The Autonomous Future: \"Make My Meta Ads Better\"

    26:00 — Recursive Improvement: Agents That Optimize Themselves

    30:00 — Do You Even Need to Be a Paid Marketer Anymore?

    32:00 — Power Collaborators: The New Marketing Skillset

    34:00 — Small Businesses Competing with Nike
  ...
  duration: "PT35M43S"
  publishedAt: "2026-02-26T15:53:39Z"
  thumbnailUrl: "https://i.ytimg.com/vi/9LNNAQbKLdc/hqdefault.jpg"
  youtubeUrl: "https://www.youtube.com/watch?v=9LNNAQbKLdc"
processedAt: "2026-02-27T00:08:47.858Z"
source: "youtube"
tldr: "Supercale's Patrick Haiti demos an AI agent that automates ad creation, analysis, and iteration for platforms like Meta and TikTok, enabling even small businesses to generate high-quality, data-driven video ads at scale for just $49/month."
tools:
  - name: "Shopify"
    url: "null"
  - name: "Meta"
...
This episode of Marketing Against the Grain features Patrick Haiti, founder of Supercale, discussing how AI agents are revolutionizing ad creation and management, particularly for video ads. The key is leveraging AI to democratize access to high-quality marketing, enabling businesses of all sizes to compete effectively.

*   **AI agents** can automate the entire ad campaign process, from research and creation to analysis and iteration, significantly reducing time and cost.

*   The platform uses **AI-generated avatars** to create engaging video ads, allowing brands to establish a consistent persona across all content channels.

*   **Training the AI agent** with specific brand guidelines and data improves its performance, leading to more relevant and effective ad campaigns; the more context provided, the better the results.

*   The future of marketing involves **power collaborators**: marketers who know how to best prompt and work with AI agents, combining human creativity with AI efficiency.

*   **Speed of learning and iteration** is crucial; companies that adopt AI agents early and run more creatives will outcompete others due to the Meta algorithm prioritizing visual differentiation.

*   Supercale's agent operates on a **loop marketing** framework: expressing brand story, tailoring ad variations, amplifying distribution, and evolving through performance data.
...
Marketing Against the Grain, hosted by Kieran and Kip, explores innovative strategies in marketing and business growth. Patrick Haiti, the founder of Supercale, brings his expertise in AI-driven advertising to the conversation. This discussion is particularly relevant now as businesses face increasing pressure to optimize their ad spend and compete in a rapidly evolving digital landscape. The rise of AI agents in marketing offers a potential solution, enabling businesses to automate and scale their ad campaigns more efficiently. This video would benefit marketers, business owners, and anyone interested in leveraging AI to improve their advertising efforts.