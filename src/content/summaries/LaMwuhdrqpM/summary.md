...
metadata:
  ...
  description: "Unbelievable! Mix 1 cup lentils with water to surprise everyone! Incredibly simple and delicious lentil recipe! This lentil tofu tastes better than meat and is high protein. Incredibly tasty way to cook lentils! My whole family and friends like it so much! Watch the video and learn the new way how to cook lentils at home, it’s easy, highly nutritious! Everyone will be delighted with its taste! Happy cooking and wishing you a wonderful day! 😊 💖
    ...
    1 cup red lentils (7oz | 200g)

    3 cups boiling water (24fl oz | 700ml)
    ...
    ℹ️ You can store lentil tofu in an air-tight container in the fridge for up to 4 days.
  ...
  channelId: "UCF0yxeCMkXjUhXgmOnsvs8w"
  duration: "PT3M15S"
  publishedAt: "2025-10-19T17:00:32Z"
  thumbnailUrl: "https://i.ytimg.com/vi/LaMwuhdrqpM/hqdefault.jpg"
  youtubeUrl: "https://www.youtube.com/watch?v=LaMwuhdrqpM"
processedAt: "2026-01-16T15:19:15.971Z"
source: "youtube"
playlistId: "PL-SEjLl-bojUBbH6pniyrHDaxs-WO6E7R"
playlistName: "Personal"
category: "personal"
tldr: "Create a high-protein soy-free tofu using only red lentils and water:

  - **Preparation**: Soak 1 cup rinsed red lentils in 3 cups boiling water for 30 minutes, then blend smooth.

  - **Cooking**: Whisk constantly over heat for 7-10 minutes until thick, then set in the fridge overnight.

  - **Finishing**: Slice into cubes and air fry at 400°F (200°C) for 15 minutes for a crispy texture.\n"
ai:
  provider: "gemini"
...
This tutorial provides a simple method for creating a versatile plant-based protein alternative using common pantry staples.

*   **Red Lentils** act as a natural thickening agent and protein source, allowing for a firm, sliceable texture without soy or processed additives.

*   The **cooking technique** requires constant whisking to ensure a smooth, lump-free consistency as the starches gelatinize.

*   **Overnight refrigeration** is crucial for the block to fully set and achieve a texture comparable to firm traditional tofu.

*   **Air frying** or seasoning the finished cubes transforms the neutral lentil base into a crispy, flavorful ingredient for various dishes.
...
As plant-based diets continue to grow in popularity, many consumers are looking for whole-food alternatives to processed meat substitutes and soy-based products. Red lentil tofu, similar in concept to traditional Burmese Shan tofu (usually made from chickpeas), is a significant trend for those with soy allergies or those seeking budget-friendly, protein-dense meals. This recipe is particularly relevant for home cooks interested in food self-sufficiency and clean-label eating, as it utilizes a single shelf-stable ingredient to replicate the culinary utility of a versatile refrigerated staple. It bridges the gap between raw legumes and convenient, ready-to-cook meat alternatives.
