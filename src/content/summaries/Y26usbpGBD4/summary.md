...
metadata:
  ...
  description: "Discover what’s new in Ahrefs with our April 2025 updates round-up.
    ...
    ***************************************
    ...
    ► Location filters allow for tracking brand visibility in specific countries or regions.
  ...
  duration: "PT5M26S"
  publishedAt: "2025-05-12T13:31:47Z"
  thumbnailUrl: "https://i.ytimg.com/vi/Y26usbpGBD4/hqdefault.jpg"
  youtubeUrl: "https://www.youtube.com/watch?v=Y26usbpGBD4"
processedAt: "2026-02-23T16:53:23.779Z"
source: "youtube"
tldr: "Ahrefs launched nine major updates including Rank Tracker 2.0 with faster SEO monitoring and bulk keyword management, always-on site audits for real-time issue alerts, Brand Radar web page coverage, AI content helper, and dashboard enhancements."
tools:
  - name: "Ahrefs"
    url: null
  - name: "Cloudflare"
...
Ahrefs has introduced significant updates to its SEO and analytics platform. • **Rank Tracker 2.0** offers faster reports, bulk keyword operations, and search intent analysis. • **Always-on Site Audits (AOA)** enable continuous crawling with real-time alerts for critical issues, requiring Pro or Max plans. • **Brand Radar** now includes web page analysis, location filters, and competitive metrics for better brand monitoring. • Other enhancements cover AI content assistance, customizable menu, and refined web analytics.
...
These updates are crucial for SEO professionals, digital marketers, and website owners who need real-time monitoring and efficient workflows. They address trends towards automation, AI integration, and proactive issue resolution in SEO tools, enhancing competitive analysis and site health management.